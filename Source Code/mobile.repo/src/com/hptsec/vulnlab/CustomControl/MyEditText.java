package com.hptsec.vulnlab.CustomControl;
...
public class MyEditText extends EditText {
	...
	// getContext().getAssets(), "fonts/Vegur_B_0.602.otf"));
	// } else {
	// super.setTypeface(Typeface.createFromAsset(
	// getContext().getAssets(), "fonts/Vegur_R_0.602.otf"));
	// }
	// }
